/* Realm design system — dark atelier, molten-bronze accent */
:root {
  --accent: #d98c3f;
  --accent2: #f0b366;
  --ink: #100d0a;
...
.serif { font-family: var(--font-cinzel), serif; letter-spacing: .02em; }
...
.card-hover:hover { transform: translateY(-4px); border-color: var(--accent); box-shadow: 0 16px 40px -20px rgba(217,140,63,.5); }
